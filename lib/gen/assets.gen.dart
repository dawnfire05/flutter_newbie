...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/view_grid_filled.svg
  SvgGenImage get viewGridFilled =>
      const SvgGenImage('assets/icons/view_grid_filled.svg');

  /// File path: assets/icons/view_grid_outline.svg
  SvgGenImage get viewGridOutline =>
      const SvgGenImage('assets/icons/view_grid_outline.svg');

  /// File path: assets/icons/write.svg
  SvgGenImage get write => const SvgGenImage('assets/icons/write.svg');
